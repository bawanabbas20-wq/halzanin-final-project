<x-halzanin-auth-layout>
    ...
    <div class="w-full">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="relative">
                <div class="absolute inset-y-0 ltr:left-0 rtl:right-0 flex items-center ltr:pl-4 rtl:pr-4 pointer-events-none text-sm font-semibold text-gray-400">
                    +964
                </div>
                <input id="phone_number" type="tel" name="phone_number" value="{{ old('phone_number') }}" autocomplete="tel" required
                       placeholder="07XX XXX XXXX"
                       class="block w-full h-[48px] ltr:pl-14 rtl:pr-14 rtl:pl-4 ltr:pr-4 rounded-[10px] border-gray-300 dark:border-gray-600 dark:bg-[#0f172a] dark:text-white focus:border-brand focus:ring-0 focus:shadow-[0_0_0_3px_#e0e7ff] dark:focus:shadow-[0_0_0_3px_rgba(49,46,129,0.5)] transition-all duration-200">
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">This phone number will be the main contact for WhatsApp verification later.</p>
