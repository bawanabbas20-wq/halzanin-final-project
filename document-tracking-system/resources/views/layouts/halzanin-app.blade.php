        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="hidden lg:flex lg:flex-col w-[240px] bg-brand text-white flex-shrink-0 shadow-xl relative z-30">
                ...
                <nav class="flex-1 px-4 space-y-2 mt-4 overflow-y-auto">
                    ...
                    @elseif(auth()->user()->role === 'staff')
                        ...
                        <a href="{{ route('staff.scan') }}" class="{{ request()->routeIs('staff.scan') ? 'bg-white/10 text-white font-semibold' : 'text-white/70 hover:bg-white/5 hover:text-white' }} flex items-center px-4 py-3 rounded-xl transition-all">
                    ...
                    @else
                        ...
                        <a href="{{ route('citizen.applications.index') }}" class="{{ request()->routeIs('citizen.applications.*') ? 'bg-white/10 text-white font-semibold' : 'text-white/70 hover:bg-white/5 hover:text-white' }} flex items-center px-4 py-3 rounded-xl transition-all">
            ...
            <div class="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 flex items-center justify-around pb-safe pt-2 px-2 z-50 h-[68px] shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                @if(auth()->user()->role === 'admin')
                    ...
                    <a href="{{ route('admin.users') }}" class="flex flex-col items-center justify-center w-full h-full {{ request()->routeIs('admin.users') ? 'text-brand dark:text-indigo-400' : 'text-gray-400 hover:text-brand' }}">
                    ...
                    <a href="{{ route('admin.sub-roles.index') }}" class="flex flex-col items-center justify-center w-full h-full {{ request()->routeIs('admin.sub-roles.*') ? 'text-brand dark:text-indigo-400' : 'text-gray-400 hover:text-brand' }}">
                        ...
                        <span class="text-[10px] font-semibold">Roles</span>
                    </a>
                ...
                @elseif(auth()->user()->role === 'staff')
                    ...
                    <a href="{{ route('staff.queue') }}" class="flex flex-col items-center justify-center w-full h-full {{ request()->routeIs('staff.queue', 'staff.applications.*') ? 'text-brand dark:text-indigo-400' : 'text-gray-400 hover:text-brand' }}">
                ...
                @else
                    ...
                    <a href="{{ route('citizen.applications.index') }}" class="flex flex-col items-center justify-center w-full h-full {{ request()->routeIs('citizen.applications.*') ? 'text-brand dark:text-indigo-400' : 'text-gray-400 hover:text-brand' }}">
        ...
        <div id="chatbot-wrapper" style="position:fixed;bottom:88px;right:20px;z-index:10000;display:flex;flex-direction:column;align-items:flex-end;gap:12px;">
            ...
            <div style="position:relative;">
                ...
                <button id="chatbot-btn" onclick="toggleChat()"
                        style="width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#4338ca,#6366f1);border:none;color:#fff;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 10px 25px -5px rgba(67,56,202,0.5);transition:transform 0.2s,box-shadow 0.2s;position:relative;z-index:1;"
                        onmouseover="this.style.transform='scale(1.08)';this.style.boxShadow='0 15px 30px -5px rgba(67,56,202,0.6)'"
                        onmouseout="this.style.transform='scale(1)';this.style.boxShadow='0 10px 25px -5px rgba(67,56,202,0.5)'">
