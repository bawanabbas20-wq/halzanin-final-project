                    ...
                    <div class="relative h-[220px] flex items-end justify-between pt-6 border-b border-gray-200 dark:border-slate-700 pb-2">
                        ...
                        @foreach($chartData as $index => $data)
                            ...
                            <div class="relative flex flex-col items-center flex-1 group h-full justify-end z-10">
                                ...
                                <div class="w-8 sm:w-10 rounded-t-lg origin-bottom bg-gradient-to-t from-brand to-indigo-400 dark:from-indigo-600 dark:to-indigo-400 hover:from-indigo-500 hover:to-accent transition-all"
                ...
                <div class="p-6 flex flex-col h-full">
                    ...
                    <div class="flex flex-col space-y-3 flex-grow justify-center">
                        ...
                        <a href="{{ route('admin.users') }}"
                           class="w-full py-3.5 bg-white dark:bg-slate-800 text-brand dark:text-indigo-400 border-2 border-brand/20 dark:border-indigo-700 text-center rounded-xl font-semibold font-outfit hover:border-brand dark:hover:border-indigo-500 hover:bg-brand/5 dark:hover:bg-slate-700 transition-all flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr class="hover:bg-gray-50/70 dark:hover:bg-slate-800/50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-full bg-brand/10 dark:bg-indigo-900/30 flex items-center justify-center text-brand dark:text-indigo-400 font-bold text-sm shrink-0">
