            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="2"
                              class="block w-full px-4 py-3 rounded-xl border-gray-300 dark:border-gray-600 dark:bg-[#141414] dark:text-white focus:border-brand focus:ring-0 transition-all resize-none">{{ old('description', $subRole->description) }}</textarea>
                </div>
            </div>
