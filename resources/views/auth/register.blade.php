    ...
    <div class="w-full">
        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex flex-col items-center flex-1">
                ...
                <span class="text-xs text-brand font-medium mt-1" data-i18n="auth.step1">Step 1</span>
            </div>
            ...
            <div class="flex flex-col items-center flex-1">
                ...
                <span class="text-xs text-gray-400 font-medium mt-1" data-i18n="auth.step2">Step 2</span>
            </div>
            <div class="h-0.5 bg-gray-200 dark:bg-gray-700 flex-1 mx-2 mt-[-16px]"></div>
            <div class="flex flex-col items-center flex-1">
                ...
                <span class="text-xs text-gray-400 font-medium mt-1" data-i18n="auth.step3">Step 3</span>
            </div>
        </div>
