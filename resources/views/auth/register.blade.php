    ...
    <div class="w-full">
        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex flex-col items-center flex-1">
                ...
                <span class="text-xs text-brand font-medium mt-1" data-i18n="Step 1">Step 1</span>
            </div>
            ...
            <div class="flex flex-col items-center flex-1">
                ...
                <span class="text-xs text-gray-400 font-medium mt-1" data-i18n="Step 2">Step 2</span>
            </div>
            <div class="h-0.5 bg-gray-200 dark:bg-gray-700 flex-1 mx-2 mt-[-16px]"></div>
            <div class="flex flex-col items-center flex-1">
                ...
                <span class="text-xs text-gray-400 font-medium mt-1" data-i18n="Step 3">Step 3</span>
            </div>
        </div>

        <h2 class="text-[22px] font-semibold text-brand dark:text-white mb-6 font-outfit" data-i18n="Create your account">Create your account</h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="relative">
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name"
                       placeholder="Full Name" data-i18n-placeholder="Full Name"
            ...
            <div class="relative">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                       placeholder="Confirm Password" data-i18n-placeholder="Confirm Password"
                       class="block w-full h-[48px] ltr:pl-11 rtl:pr-11 rtl:pl-4 ltr:pr-4 rounded-[10px] border-gray-300 dark:border-gray-600 dark:bg-[#0f172a] dark:text-white focus:border-brand focus:ring-0 focus:shadow-[0_0_0_3px_#e0e7ff] dark:focus:shadow-[0_0_0_3px_rgba(49,46,129,0.5)] transition-all duration-200">
                <x-input-error :messages="$errors->get('password_confirmation')" class="mt-1" />
            </div>

            <!-- Register Button -->
            <button type="submit" class="w-full h-[52px] bg-brand text-white rounded-[10px] font-semibold font-outfit shadow-brand-btn hover:shadow-brand-btn-hover hover:-translate-y-[1px] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand dark:focus:ring-offset-[#1e293b] mt-6" data-i18n="Create Account">
                Create Account
            </button>
            ...
            <div class="text-center text-sm text-gray-600 dark:text-gray-400 pt-4">
                ...
                <a href="{{ route('login') }}" class="font-semibold text-brand dark:text-indigo-400 hover:underline" data-i18n="Log in">Log in</a>
            </div>
        </form>
    </div>
