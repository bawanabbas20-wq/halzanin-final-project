...
<div class="w-full max-w-[480px] mx-auto flex flex-col items-center">
    ...
    <div class="flex flex-col items-center text-center mb-8 print:hidden animate-fade-in">
        ...
        <p class="text-gray-500 dark:text-gray-400 text-sm" data-i18n="qr.ready">Your QR receipt is ready — download or save it</p>
    </div>
    ...
    <div class="w-full flex flex-col space-y-3 mt-8 animate-fade-up print:hidden" style="animation-delay: 500ms;">
        <a href="{{ route('citizen.applications.receipt.pdf', $application) }}" download
            ...
            <span data-i18n="qr.download">Download Receipt</span>
        </a>
