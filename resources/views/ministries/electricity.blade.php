...
.mn-hero-photo{
  ...
  background:url('https://picsum.photos/seed/electricity-kr/1600/700') center/cover no-repeat;
...
.mn-contact-card{
  background:var(--card);border-radius:var(--radius);
  border:1px solid var(--border);padding:1.75rem;box-shadow:var(--shadow);
}
.mn-contact-row{
...
.mn-map-placeholder{
  ...
  aspect-ratio:4/3;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.6rem;
...
<nav class="mn-nav" aria-label="Site navigation">
  <div class="mn-nav-left">
    ...
    <nav class="mn-breadcrumb" aria-label="Breadcrumb">
      ...
      <span>›</span>
      <span class="mn-breadcrumb-cur"><span data-en>Electricity</span><span data-ku class="ku">کارەبا</span></span>
    </nav>
  </div>
  <div class="mn-nav-right">
    <button class="mn-nav-btn" onclick="toggleLang()" aria-label="Toggle language" id="lang-btn">کوردی | EN</button>
...
<section class="mn-section" id="about" aria-labelledby="about-title">
  <div class="mn-section-inner">
    <div class="mn-about-grid">
      ...
      <img
        src="https://picsum.photos/seed/electricity-kr-about/800/600"
  ...
  <div class="mn-section-inner">
    ...
    <div class="mn-news-grid" role="list">
      <article class="mn-news-card" role="listitem">
        <img src="https://picsum.photos/seed/elec-news-1/600/300" alt="New power plant announcement" class="mn-news-thumb" loading="lazy"/>
      ...
      <article class="mn-news-card" role="listitem">
        <img src="https://picsum.photos/seed/elec-news-2/600/300" alt="Smart meter rollout" class="mn-news-thumb" loading="lazy"/>
        <div class="mn-news-content">
      ...
      <article class="mn-news-card" role="listitem">
        <img src="https://picsum.photos/seed/elec-news-3/600/300" alt="Solar energy project" class="mn-news-thumb" loading="lazy"/>
        <div class="mn-news-content">
        ...
        <div class="mn-contact-row" role="listitem">
          ...
          <div>
            ...
            <p class="mn-contact-val">
              <span data-en>Ministry of Electricity HQ, Ankawa Road, Erbil, Kurdistan Region</span>
              <span data-ku class="ku">چەواری سەرەکیی وەزارەتی کارەبا، ڕێگای عەنکاوە، هەولێر، هەرێمی کوردستان</span>
            </p>
          </div>
        </div>
        <div class="mn-contact-row" role="listitem">
          ...
          <div>
            ...
            <p class="mn-contact-val">
              <span data-en>Sunday – Thursday, 8:00 – 15:00 (Fault reports: 24 hrs)</span>
              <span data-ku class="ku">یەکشەممە – پێنجشەممە، ٨:٠٠ – ١٥:٠٠ (ڕاپۆرتی خراپی: ٢٤ کاتژمێر)</span>
            </p>
          </div>
        </div>
        <div class="mn-contact-row" role="listitem">
          ...
          <div>
            ...
            <p class="mn-contact-val" dir="ltr">+964 66 333 7890</p>
          </div>
        </div>
        <div class="mn-contact-row" role="listitem">
          <div class="mn-contact-ico" aria-hidden="true"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg></div>
          <div>
            <p class="mn-contact-lbl"><span data-en>Emergency line</span><span data-ku class="ku">هێڵی فریاگوزاری</span></p>
            <p class="mn-contact-val" dir="ltr">115 (24/7)</p>
          </div>
        </div>
      </div>
      <div class="mn-map-placeholder" aria-label="Map placeholder — Ministry of Electricity, Ankawa Road, Erbil">
        ...
        <span data-en>Map — Ankawa Road, Erbil</span>
        <span data-ku class="ku">نەخشە — ڕێگای عەنکاوە، هەولێر</span>
      </div>
    </div>
  </div>
</section>
...
<footer class="mn-footer" role="contentinfo">
  <span class="mn-footer-brand">
    <span data-en>Ministry of Electricity — Halzanîn</span>
    <span data-ku class="ku">وەزارەتی کارەبا — هەڵژانین</span>
  </span>
  ...
  <p class="mn-footer-copy">
    <span data-en>© 2026 Kurdistan Regional Government — Ministry of Electricity. All rights reserved.</span>
    <span data-ku class="ku">© ٢٠٢٦ حکومەتی هەرێمی کوردستان — وەزارەتی کارەبا. هەموو مافەکان پارێزراون.</span>
  </p>
</footer>
...
(function(){
  ...
  window.toggleLang = function(){
    setLang(document.body.classList.contains('lang-ku') ? 'en' : 'ku');
  };
