    ...
    <head>
        ...
        <style>
            ...
            *, *::before, *::after { box-sizing: border-box; }
            ...
            .al-left-inner { position: relative; z-index: 1; display: flex; flex-direction: column; height: 100%; }
            ...
            html[dir="rtl"] .al-toggles { justify-content: flex-start; }
            ...
            .al-theme-btn:hover { box-shadow: 0 0 0 3px rgba(27,79,138,0.15); }
            ...
            .al-lang-opt.al-active {
                background: #1B4F8A;
                color: #fff;
                box-shadow: 0 2px 8px rgba(27,79,138,0.32);
            }
            ...
            .al-card {
                ...
                width: 100%;
                max-width: 420px;
                animation: al-slide-up 0.38s ease both;
            }
            html.dark .al-card {
                background: #1F1F1F;
                border-color: #2E2E2E;
            ...
            @media (max-width: 900px) {
                .al-left { width: 340px; }
                .al-left { padding: 36px 28px 28px; }
            }
            @media (max-width: 700px) {
                .al-left { display: none; }
                .al-right { background: #EFEDE8; }
                html.dark .al-right { background: #141414; }
                .al-card { padding: 28px 24px; }
            }
        </style>
    </head>
        ...
        <div class="al-right">
            ...
            <div class="al-toggles">
                <button id="theme-toggle" class="al-theme-btn" aria-label="Toggle dark mode">
                    <svg id="al-sun-icon" style="display:none;" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/>
                        <line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/>
                        <line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/>
                        <line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/>
                    </svg>
                    <svg id="al-moon-icon" style="display:none;" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
