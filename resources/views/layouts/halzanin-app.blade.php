        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="hidden lg:flex lg:flex-col w-56 bg-white dark:bg-[#1F1F1F] border-r border-stone-200 dark:border-slate-800 flex-shrink-0 relative z-30">
                ...
                <nav class="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto">
                    ...
                    @elseif(auth()->user()->role === 'ministry_admin')
                        <a href="{{ route('ministry_admin.dashboard') }}" class="{{ request()->routeIs('ministry_admin.dashboard') ? $navActive : $navInactive }} {{ $navBase }}">
                            <svg class="w-5 h-5 shrink-0 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                            <span>Dashboard</span>
                        </a>
                        <a href="{{ route('ministry_admin.users') }}" class="{{ request()->routeIs('ministry_admin.users') ? $navActive : $navInactive }} {{ $navBase }}">
                            <svg class="w-5 h-5 shrink-0 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span>My Staff</span>
                        </a>
                        <a href="{{ route('ministry_admin.off_days') }}" class="{{ request()->routeIs('ministry_admin.off_days') ? $navActive : $navInactive }} {{ $navBase }}">
                            <svg class="w-5 h-5 shrink-0 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
            ...
            <div class="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1F1F1F] border-t border-gray-200 dark:border-[#2E2E2E] flex items-center justify-around pb-safe pt-2 px-2 z-50 h-[68px] shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                ...
                @elseif(auth()->user()->role === 'ministry_admin')
                    <a href="{{ route('ministry_admin.dashboard') }}" class="flex flex-col items-center justify-center w-full h-full {{ request()->routeIs('ministry_admin.dashboard') ? 'text-brand dark:text-blue-400' : 'text-gray-400 hover:text-brand' }}">
                        <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        <span class="text-[10px] font-semibold">Dashboard</span>
                    </a>
                    <a href="{{ route('ministry_admin.users') }}" class="flex flex-col items-center justify-center w-full h-full {{ request()->routeIs('ministry_admin.users') ? 'text-brand dark:text-blue-400' : 'text-gray-400 hover:text-brand' }}">
