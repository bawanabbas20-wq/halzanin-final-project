<section>
    <header>
        <h2 class="text-lg font-bold text-gray-900 dark:text-white" data-i18n="Update Password">
            {{ __('Update Password') }}
        </h2>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400" data-i18n="Ensure your account is using a long, random password to stay secure.">
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <label for="update_password_current_password" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1" data-i18n="Current Password">{{ __('Current Password') }}</label>
        ...
        <div>
            <label for="update_password_password" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1" data-i18n="New Password">{{ __('New Password') }}</label>
        ...
        <div>
            <label for="update_password_password_confirmation" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1" data-i18n="Confirm Password">{{ __('Confirm Password') }}</label>
        ...
        <div class="flex items-center gap-4">
            <button type="submit" class="px-6 h-[48px] bg-brand text-white rounded-[10px] font-semibold font-outfit shadow-brand-btn hover:shadow-brand-btn-hover hover:-translate-y-[1px] transition-all" data-i18n="Update Password">
                {{ __('Update Password') }}
            </button>
